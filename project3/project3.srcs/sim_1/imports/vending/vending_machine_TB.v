...
task general_check;
    ...
    begin
        if(available_item == o_available_item && output_item == o_output_item && current_total == o_current_total) begin
            ...
            // Custom
            $display("Your ans\t=> o_available_item: 4'b%b, o_output_item: 4'b%b, o_current_total: %0d", o_available_item, o_output_item, o_current_total);
        end
    end
endtask
task return_check;
    ...
    begin
        if(return_coin == o_return_coin) begin
            ...
            // Custom
            $display("Your ans\t=> o_return_coin: %0d", o_return_coin);
        end
    end
endtask
