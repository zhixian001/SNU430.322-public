...
// Microcode opcodes
`define MICROOP_IF          4'b000
`define MICROOP_ID          4'b001
`define MICROOP_EX          4'b010
`define MICROOP_EX_BRANCH   3'b011
`define MICROOP_WB          3'b100
`define MICROOP_MEM         3'b101
`define MICROOP_HALT        3'b110
...
// `define ALUOP_WDADDR    4'b1010 not needed
